      ...
      <section class="program_tour_content">
        <div class="blocks_about_tour">
          <div class="enabled_in_tour">
            <img src="../assets/image/element_background_program_tour.png" />
        ...
        <div class="tour_info_block">
          <div class="info_tour_column_one">
            ...
            <div id="address_block">
              <img src="../assets/image/address_marker.png" />
              <p>
        ...
        <div class="hotel_info">
          ...
          <div class="hotel_photos">
            <div class="photos_hotel_content">
              <img src="../assets/image/hotel_background.png" />
              <div class="block_photo"></div>
            </div>
            <div class="arrows_row">
              <img alt="arrow_left" src="../assets/image/arrow_main.png" />
              <img
                class="arrow_main_right"
                alt="arrow_right"
                src="../assets/image/arrow_main.png"
              />
            </div>
          </div>
        </div>
